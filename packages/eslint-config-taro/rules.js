module.exports = {
  rules: {
    ...
    'operator-linebreak': [2, 'after', { // 一致换行符
      'overrides': {
        '?': 'before',
        ':': 'before'
      }
    ...
    'spaced-comment': [2, 'always', { // 注释前有空白
    ...
    'no-magic-numbers': [1, { 'ignore': [1, 2], 'ignoreArrayIndexes': true }],
    'require-await': 2
  }
}